...
const ModalFilter = ({ isModalOpen, setIsModalOpen }: HeaderProps) => {
    ...
    return (
        <>
            <Modal
                title={
                    <p className="text-center text-2xl text-black font-bold font-arial">BỘ LỌC</p>
                }
                open={isModalOpen}
                closeIcon={false}
                footer={null}
            >
                ...
                <Form name="filter" onFinish={onFinish} layout="vertical">
                    <Form.Item label="Loại gói cước" name="package">
                        <Select
                    ...
                    <Form.Item label="Thời gian sử dụng" name="time">
                        <Select
                            defaultValue="day"
                            style={{ width: "100%" }}
                    ...
                    <Form.Item label="Sắp xếp theo" name="order">
                        <Select
                            defaultValue="asc"
                            style={{ width: "100%" }}
                            onChange={handleChangeTime}
